...
if (isset($_POST['insert'])) {
    ...
    $existing_Query = "SELECT * FROM `addtable` WHERE `faculty`='$data[0]' AND `course`='$data[1]' AND `subject`='$data[2]' AND `room`='$data[3]' AND `start_time`='$data[4]' AND `end_time`='$data[5]'";
